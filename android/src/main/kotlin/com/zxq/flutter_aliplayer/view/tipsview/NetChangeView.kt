...
class NetChangeView : RelativeLayout, ITheme {
    ...
    private fun init() {
        ...
        val viewWidth = resources.getDimensionPixelSize(R.dimen.alivc_player_dialog_netchange_width)
        val viewHeight = resources.getDimensionPixelSize(R.dimen.alivc_player_dialog_netchange_height)

        val params = RelativeLayout.LayoutParams(viewWidth, viewHeight)
        addView(view, params)

        //继续播放的点击事件
        view.findViewById<View>(R.id.continue_play).setOnClickListener {
    ...
    override fun setTheme(theme: AliyunVodPlayerView.Theme) {
        ...
        if (theme == AliyunVodPlayerView.Theme.Blue) {
            ...
            mStopPlayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_blue))
        } else if (theme == AliyunVodPlayerView.Theme.Green) {
            mStopPlayBtn!!.setBackgroundResource(R.drawable.alivc_rr_bg_green)
            mStopPlayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_green))
        } else if (theme == AliyunVodPlayerView.Theme.Orange) {
            mStopPlayBtn!!.setBackgroundResource(R.drawable.alivc_rr_bg_orange)
            mStopPlayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_orange))
        } else if (theme == AliyunVodPlayerView.Theme.Red) {
            mStopPlayBtn!!.setBackgroundResource(R.drawable.alivc_rr_bg_red)
            mStopPlayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_red))
        }
    }
