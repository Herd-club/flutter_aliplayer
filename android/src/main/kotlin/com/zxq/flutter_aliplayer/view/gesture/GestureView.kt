package com.zxq.flutter_aliplayer.view.gesture
 ...
 * 此view主要被[com.zxq.flutter_aliplayer.widget.AliyunVodPlayerView] 使用。
 */
class GestureView : View, ViewAction {

    //手势控制
    protected lateinit var mGestureControl: GestureControl
    //监听器
