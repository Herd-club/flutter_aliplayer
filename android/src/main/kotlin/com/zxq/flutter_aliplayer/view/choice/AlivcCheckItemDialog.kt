...
class AlivcCheckItemDialog : Dialog {
    ...
    private fun animateDown() {
        ...
        set.setAnimationListener(object : Animation.AnimationListener {
            ...
            override fun onAnimationEnd(animation: Animation) {
                ...
                mContentView!!.post {
                    try {
                        super@AlivcCheckItemDialog.dismiss()
                    } catch (e: Exception) {
    ...
    /**
     * 生成底部选择[AlivcCheckItemDialog]对话框
     */
    class BottomListCheckBuilder(private val mContext: Context) {
        private var alivcCheckItemDialog: AlivcCheckItemDialog? = null
         ...
         * @return
         */
        fun build(): AlivcCheckItemDialog {
            alivcCheckItemDialog = AlivcCheckItemDialog(mContext)
            val contentView = buildViews()
            alivcCheckItemDialog!!.setContentView(contentView, ViewGroup.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT))
        ...
        interface OnCheckItemClickListener {
            fun onClick(dialog: AlivcCheckItemDialog?, itemView: View, position: Int, tag: String)
        }
    ...
    companion object {
        ...
        private val TAG = AlivcCheckItemDialog::class.java.name
