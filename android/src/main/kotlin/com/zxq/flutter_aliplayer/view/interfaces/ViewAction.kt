package com.zxq.flutter_aliplayer.view.interfaces
...
/**
 * 定义UI界面通用的操作。
 * 主要实现类有[com.zxq.flutter_aliplayer.view.control.ControlView] ,
 * [com.zxq.flutter_aliplayer.view.gesture.GestureView]
 */
