...
open class BaseGestureDialog(context: Context) : PopupWindow() {
    ...
    init {
        //使用同一个布局
        val mInflater = context.applicationContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        ...
        //设置对话框宽高
        mDialogWidthAndHeight = context.resources.getDimensionPixelSize(R.dimen.alivc_player_gesture_dialog_size)
