...
class ReplayView : RelativeLayout, ITheme {
    ...
    override fun setTheme(theme: AliyunVodPlayerView.Theme) {
        ...
        if (theme == AliyunVodPlayerView.Theme.Blue) {
            ...
            mReplayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_blue))
        } else if (theme == AliyunVodPlayerView.Theme.Green) {
            mReplayBtn!!.setBackgroundResource(R.drawable.alivc_rr_bg_green)
            mReplayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_green))
        } else if (theme == AliyunVodPlayerView.Theme.Orange) {
            mReplayBtn!!.setBackgroundResource(R.drawable.alivc_rr_bg_orange)
            mReplayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_orange))
        } else if (theme == AliyunVodPlayerView.Theme.Red) {
            mReplayBtn!!.setBackgroundResource(R.drawable.alivc_rr_bg_red)
            mReplayBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_red))
        }
    }
