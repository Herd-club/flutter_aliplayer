package com.zxq.flutter_aliplayer.view.speed
...
class SpeedView : RelativeLayout, ITheme {
    ...
    private var mMainSpeedView: View? = null
    //显示动画
    ...
    private fun init() {
        ...
        //找出控件
        mOneQrtTimeBtn = findViewById<View>(R.id.one_quartern) as RadioButton
        mNormalBtn = findViewById<View>(R.id.normal) as RadioButton
        mOneHalfTimeBtn = findViewById<View>(R.id.one_half) as RadioButton
        ...
        hideAnim!!.setAnimationListener(object : Animation.AnimationListener {
            ...
            override fun onAnimationEnd(animation: Animation) {
                ...
                if (mSpeedChanged) {
                    ...
                    val tips = context.getString(R.string.alivc_speed_tips, times)
                    mSpeedTip!!.text = tips
    ...
    private fun setRadioButtonTheme(button: RadioButton) {
        if (button.isChecked) {
            ...
            button.setTextColor(ContextCompat.getColor(context, R.color.alivc_common_font_white_light))
        }
    }

    private inner class MyLayoutListener : ViewTreeObserver.OnGlobalLayoutListener {
