...
import com.zxq.flutter_aliplayer.view.gesturedialog.SeekDialog
import com.zxq.flutter_aliplayer.view.gesturedialog.VolumeDialog
...
class GestureDialogManager(//用于构建手势用的dialog
    ...
    fun updateSeekDialog(duration: Long, currentPosition: Long, deltaPosition: Long) {
        val targetPosition = mSeekDialog!!.getTargetPosition(duration, currentPosition, deltaPosition)
        mSeekDialog!!.updatePosition(targetPosition)
    }
