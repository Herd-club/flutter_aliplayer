...
class ErrorView : RelativeLayout, ITheme {
    ...
    private fun init() {
        ...
        val viewHeight = resources.getDimensionPixelSize(R.dimen.alivc_player_dialog_err_height)
    ...
    fun updateTips(errorCode: Int, errorEvent: String, errMsg: String) {
        ...
        mCodeView!!.text = context.getString(R.string.alivc_error_code) + errorCode + " - " + errorEvent
    }
    ...
    override fun setTheme(theme: AliyunVodPlayerView.Theme) {
        if (theme == AliyunVodPlayerView.Theme.Blue) {
            ...
            mRetryBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_blue))
            ...
            mRetryBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_green))
            ...
            mRetryBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_orange))
            ...
            mRetryBtn!!.setTextColor(ContextCompat.getColor(context, R.color.alivc_player_theme_red))
        }
    }
