package com.zxq.flutter_aliplayer.view.guide
...
/**
 * 手势指导页面。
 * 主要在[com.zxq.flutter_aliplayer.widget.AliyunVodPlayerView] 使用。
 */
...
class GuideView : LinearLayout, ITheme {
    ...
    fun setScreenMode(mode: AliyunScreenMode) {
        ...
        val spf = context.getSharedPreferences("alivc_guide_record", Context.MODE_PRIVATE)
