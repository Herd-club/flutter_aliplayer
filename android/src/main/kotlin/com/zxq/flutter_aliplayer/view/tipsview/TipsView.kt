...
class TipsView : RelativeLayout, ITheme {
    ...
    //网络变化监听事件。
    private val onNetChangeClickListener = object : NetChangeView.OnNetChangeClickListener {
    ...
    //错误提示的重试点击事件
    private val onRetryClickListener = object : ErrorView.OnRetryClickListener {
    ...
    //重播点击事件
    private val onReplayClickListener = object : ReplayView.OnReplayClickListener {
