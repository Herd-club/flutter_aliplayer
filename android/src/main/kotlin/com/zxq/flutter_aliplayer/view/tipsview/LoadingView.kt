...
class LoadingView : RelativeLayout {
    ...
    private fun init() {
        ...
        val viewWidth = resources.getDimensionPixelSize(R.dimen.alivc_palyer_dialog_loading_width)
        val viewHeight = resources.getDimensionPixelSize(R.dimen.alivc_palyer_dialog_loading_width)
