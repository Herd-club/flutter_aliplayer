        ...
        if (mLandOrientationListener == null) {
            mLandOrientationListener = object : OrientationEventListener(mContext, SensorManager.SENSOR_DELAY_NORMAL) {
                override fun onOrientationChanged(orientation: Int) {
                    ...
                    //竖屏类似。
                    val isLand = orientation < 100 && orientation > 80 || orientation < 280 && orientation > 260

                    val isPort = orientation < 10 || orientation > 350 || orientation < 190 && orientation > 170

                    if (isLand) {
                        if (mOrientationListener != null && orientation < 100 && orientation > 80) {
                            VcPlayerLog.d(TAG, "ToLandForward")
                            mOrientationListener!!.changedToLandReverseScape(mLastOrientation == Orientation.Port || mLastOrientation == Orientation.Land_Forward)
                            ...
                            mOrientationListener!!.changedToLandForwardScape(mLastOrientation == Orientation.Port || mLastOrientation == Orientation.Land_Reverse)
                        ...
                        if (mOrientationListener != null) {
                            ...
                            mOrientationListener!!.changedToPortrait(mLastOrientation == Orientation.Land_Reverse || mLastOrientation == Orientation.Land_Forward)
                        }
